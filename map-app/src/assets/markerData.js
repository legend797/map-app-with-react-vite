...
import icon1 from '../assets/airStrike.svg';
import icon2 from '../assets/armed.svg';
import icon3 from '../assets/massacre.svg';
import icon4 from '../assets/casualty.svg';
import icon5 from '../assets/arrest.svg';
